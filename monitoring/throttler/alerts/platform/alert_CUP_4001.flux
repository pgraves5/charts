...
|> map(fn: (r) => ({
  _reason: "If CPU usage percent crosses the threshold specified then the alert is triggered.",
  _message: "CPU usage is " + string(v: r._value) + " % crosses threshold on host " + r.host,
